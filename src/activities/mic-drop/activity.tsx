...
import { scoreAllHeuristic, MIC_DROP_WEIGHTS } from '@/lib/landing-scorer';
              ...
              return (
                <button
                  ...
                  className={`w-full text-left glass p-4 rounded-2xl border-2 transition-all ${
                    isSpotlit ? 'border-violet-400 shadow-lg shadow-violet-500/20 scale-[1.01]' : 'border-white/10 hover:border-violet-500/30'
                  }`}
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="text-right shrink-0">
                      <div className="text-2xl font-game text-violet-400">{score.finalScore}</div>
                    </div>
                  </div>
