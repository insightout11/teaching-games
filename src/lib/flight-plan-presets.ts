...
export const FLIGHT_PLAN_PRESETS: FlightPlanPreset[] = [
  ...
  },
  {
    ...
    description: 'Flagship ESL journey: warm-up, briefing, language toolkit, opinion pulse, explore, navigation check, accuracy check, main discussion, review game, wrap-up',
    lessonDurationMinutes: 60,
    goal: 'speaking-fluency',
    lessonType: 'skill-builder',
