...
const PLANE_ENTRIES: PlaneEntry[] = [
  ...
  entry('cloud-hopper',        'Cloud Hopper',     'piston',    { groundContactOffset: -43, hangarYOffset: 32 }, LC_CLOUD_HOPPER_ASSETS),
  ...
  entry('sky-racer',           'Sky Racer',        'piston',    { groundContactOffset: -27, hangarYOffset: 37 }, LC_SKY_RACER_ASSETS),
  ...
  entry('solar-flyer',         'Solar Flyer',      'electric',  { groundContactOffset: -42, hangarYOffset: 49 }, LC_SOLAR_FLYER_ASSETS),
  entry('aurora-glider',       'Aurora Glider',    'electric',  { groundContactOffset: -49, hangarYOffset: 51 }, LC_AURORA_GLIDER_ASSETS),
  ...
  entry('starliner-mini',      'Starliner Mini',   'jet',       { groundContactOffset: -27, hangarYOffset: 51 }, LC_STARLINER_MINI_ASSETS),
  entry('comet-jet',           'Comet Jet',        'jet',       { groundContactOffset: -43, hangarYOffset: 48 }, LC_COMET_JET_ASSETS),
];
