...
export const CLASS_BOARD_PRESETS: Record<string, ClassBoardPreset> = {
  ...
  'geo-detective': {
    ...
    prompt: 'Describe what you notice in the image, then guess where it could be — and say why.',
    layout: 't-chart',
    categories: [
    ...
    zones: [
      { key: 'clues', label: 'Clues', description: 'What do you notice in the image?' },
      { key: 'guesses', label: 'Guesses', description: 'Where could it be? Say why.' },
    ],
