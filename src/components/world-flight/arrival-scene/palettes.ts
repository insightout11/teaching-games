...
export const PALETTES: Record<PaletteKey, ScenePalette> = {
  dawn: {
    ...
    waterTop: '#7fa6c4',
    waterBottom: '#3a5e7c',
    buildingSilhouette: 'rgb(40,52,74)',
    windowWarm: 'rgba(255,198,104,0.62)',
    windowCool: 'rgba(178,216,255,0.5)',
    foliage: '#2f5a3a',
    trunk: '#3c2a1c',
    landmarkFill: 'rgb(46,58,82)',
  ...
  night: {
    ...
    waterTop: '#16284a',
    waterBottom: '#0a1428',
    buildingSilhouette: 'rgb(10,16,32)',
    windowWarm: 'rgba(255,194,92,0.92)',
    windowCool: 'rgba(150,206,255,0.8)',
    foliage: '#16352a',
    trunk: '#241a12',
    landmarkFill: 'rgb(8,14,30)',
  ...
  golden: {
    ...
    waterTop: '#c79a64',
    waterBottom: '#7a5a36',
    buildingSilhouette: 'rgb(58,42,30)',
    windowWarm: 'rgba(255,202,118,0.68)',
    windowCool: 'rgba(216,214,192,0.48)',
    foliage: '#6e6a2e',
    trunk: '#43301c',
    landmarkFill: 'rgb(70,48,28)',
  ...
  tropical: {
    ...
    waterTop: '#39b6c2',
    waterBottom: '#1d7d8e',
    buildingSilhouette: 'rgb(34,58,62)',
    windowWarm: 'rgba(255,210,128,0.64)',
    windowCool: 'rgba(198,240,250,0.54)',
    foliage: '#2c7a3e',
    trunk: '#4a3320',
    landmarkFill: 'rgb(34,58,58)',
  ...
  winter: {
    ...
    waterTop: '#8ea2b6',
    waterBottom: '#5a6c80',
    buildingSilhouette: 'rgb(70,82,98)',
    windowWarm: 'rgba(255,204,130,0.66)',
    windowCool: 'rgba(202,226,250,0.54)',
    foliage: '#3f5a48',
    trunk: '#3a2c22',
    landmarkFill: 'rgb(74,86,102)',
...
const TIME_BASE: Record<TimeOfDay, ScenePalette> = {
  ...
  day: {
    ...
    waterTop: '#7fb6d4',
    waterBottom: '#3f7ea0',
    buildingSilhouette: 'rgb(78,92,116)',
    windowWarm: 'rgba(255,212,138,0.4)',
    windowCool: 'rgba(198,224,248,0.4)',
    foliage: '#2f5a3a',
    trunk: '#3c2a1c',
    landmarkFill: 'rgb(86,100,124)',
