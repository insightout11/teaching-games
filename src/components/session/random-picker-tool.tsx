...
export function RandomPickerTool({ students }: RandomPickerToolProps) {
  ...
  const content = (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2" style={{ bottom: '9rem' }} ref={panelRef}>
      {/* Expandable Panel */}
      {isOpen && (
        <div className="w-80 glass rounded-xl shadow-xl border border-white/10 overflow-hidden mb-2">
          <div className="p-3 border-b border-white/10 flex items-center justify-between">
            <span className="font-semibold text-sm">Random Picker</span>
      ...
      <button
        ...
        className="w-12 h-12 rounded-full glass shadow-lg flex items-center justify-center hover:bg-white/10 transition-all border border-white/10"
        title="Random Picker"
      >
