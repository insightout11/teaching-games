...
const TRAVEL_ATTRACTION_COORDS: Partial<Record<string, { lat: number; lng: number }>> = {
  'bangkok.grand-palace': { lat: 13.75, lng: 100.4913 },
  'bangkok.wat-arun': { lat: 13.7437, lng: 100.4889 },
  'bangkok.chatuchak-market': { lat: 13.7998, lng: 100.5500 },
  'tokyo.senso-ji': { lat: 35.7148, lng: 139.7967 },
  'tokyo.meiji-jingu': { lat: 35.6764, lng: 139.6993 },
  'tokyo.shibuya-crossing': { lat: 35.6595, lng: 139.7005 },
  'seoul.gyeongbokgung': { lat: 37.5796, lng: 126.9770 },
  'seoul.n-seoul-tower': { lat: 37.5512, lng: 126.9882 },
  'seoul.bukchon-hanok-village': { lat: 37.5826, lng: 126.9830 },
  'singapore.gardens-by-the-bay': { lat: 1.2816, lng: 103.8636 },
  'singapore.marina-bay-sands': { lat: 1.2834, lng: 103.8607 },
  'singapore.singapore-botanic-gardens': { lat: 1.3138, lng: 103.8159 },
  'paris.eiffel-tower': { lat: 48.8584, lng: 2.2945 },
  'paris.louvre': { lat: 48.8606, lng: 2.3376 },
  'paris.montmartre': { lat: 48.8867, lng: 2.3431 },
  'london.tower-of-london': { lat: 51.5081, lng: -0.0759 },
  'london.british-museum': { lat: 51.5194, lng: -0.1270 },
  'london.buckingham-palace': { lat: 51.5014, lng: -0.1419 },
  'new-york.statue-of-liberty': { lat: 40.6892, lng: -74.0445 },
  'new-york.central-park': { lat: 40.7829, lng: -73.9654 },
  'new-york.times-square': { lat: 40.7580, lng: -73.9855 },
  'cairo.pyramids-of-giza': { lat: 29.9792, lng: 31.1342 },
  'cairo.egyptian-museum': { lat: 30.0478, lng: 31.2336 },
  'cairo.khan-el-khalili': { lat: 30.0477, lng: 31.2623 },
  'dubai.burj-khalifa': { lat: 25.1972, lng: 55.2744 },
  'dubai.dubai-creek': { lat: 25.2635, lng: 55.3117 },
  'dubai.al-fahidi': { lat: 25.2639, lng: 55.3000 },
  'sydney.sydney-opera-house': { lat: -33.8568, lng: 151.2153 },
  'sydney.harbour-bridge': { lat: -33.8523, lng: 151.2108 },
  'sydney.bondi-beach': { lat: -33.8915, lng: 151.2767 },
  'beijing.forbidden-city': { lat: 39.9163, lng: 116.3972 },
  'beijing.temple-of-heaven': { lat: 39.8822, lng: 116.4066 },
  'beijing.summer-palace': { lat: 39.9999, lng: 116.2755 },
  'shanghai.the-bund': { lat: 31.2400, lng: 121.4900 },
  'shanghai.yu-garden': { lat: 31.2272, lng: 121.4921 },
  'shanghai.shanghai-tower': { lat: 31.2336, lng: 121.5055 },
  'berlin.brandenburg-gate': { lat: 52.5163, lng: 13.3777 },
  'berlin.east-side-gallery': { lat: 52.5050, lng: 13.4397 },
  'berlin.museum-island': { lat: 52.5169, lng: 13.4010 },
  'moscow.red-square': { lat: 55.7539, lng: 37.6208 },
  'moscow.moscow-kremlin': { lat: 55.7520, lng: 37.6175 },
  'moscow.saint-basils-cathedral': { lat: 55.7525, lng: 37.6231 },
  'istanbul.hagia-sophia': { lat: 41.0086, lng: 28.9802 },
  'istanbul.topkapi-palace': { lat: 41.0115, lng: 28.9833 },
  'istanbul.grand-bazaar': { lat: 41.0107, lng: 28.9681 },
  'vancouver.stanley-park': { lat: 49.3043, lng: -123.1443 },
  'vancouver.granville-island': { lat: 49.2712, lng: -123.1340 },
  'vancouver.capilano-suspension-bridge': { lat: 49.3429, lng: -123.1149 },
  'toronto.cn-tower': { lat: 43.6426, lng: -79.3871 },
  'toronto.royal-ontario-museum': { lat: 43.6677, lng: -79.3948 },
  'toronto.st-lawrence-market': { lat: 43.6487, lng: -79.3715 },
  'mumbai.gateway-of-india': { lat: 18.9220, lng: 72.8347 },
  'mumbai.cst': { lat: 18.9402, lng: 72.8356 },
  'mumbai.marine-drive': { lat: 18.9430, lng: 72.8238 },
  'cape-town.table-mountain': { lat: -33.9628, lng: 18.4098 },
  'cape-town.robben-island': { lat: -33.8067, lng: 18.3662 },
  'cape-town.va-waterfront': { lat: -33.9037, lng: 18.4217 },
  'rome.colosseum': { lat: 41.8902, lng: 12.4922 },
  'rome.trevi-fountain': { lat: 41.9009, lng: 12.4833 },
  'rome.pantheon': { lat: 41.8986, lng: 12.4769 },
  'rio-de-janeiro.christ-the-redeemer': { lat: -22.9519, lng: -43.2105 },
  'rio-de-janeiro.sugarloaf-mountain': { lat: -22.9486, lng: -43.1566 },
  'rio-de-janeiro.copacabana-beach': { lat: -22.9711, lng: -43.1822 },
  'mexico-city.zocalo': { lat: 19.4326, lng: -99.1332 },
  'mexico-city.anthropology-museum': { lat: 19.4260, lng: -99.1863 },
  'mexico-city.chapultepec-castle': { lat: 19.4204, lng: -99.1819 },
  'buenos-aires.teatro-colon': { lat: -34.6010, lng: -58.3831 },
  'buenos-aires.caminito': { lat: -34.6397, lng: -58.3621 },
  'buenos-aires.recoleta-cemetery': { lat: -34.5874, lng: -58.3933 },
  'los-angeles.griffith-observatory': { lat: 34.1184, lng: -118.3004 },
  'los-angeles.getty-center': { lat: 34.0780, lng: -118.4741 },
  'los-angeles.santa-monica-pier': { lat: 34.0101, lng: -118.4960 },
  'jakarta.national-monument': { lat: -6.1754, lng: 106.8272 },
  'jakarta.kota-tua': { lat: -6.1352, lng: 106.8133 },
  'jakarta.istiqlal-mosque': { lat: -6.1702, lng: 106.8314 },
  'lagos.nike-art-gallery': { lat: 6.4287, lng: 3.5158 },
  'lagos.lekki-conservation-centre': { lat: 6.4416, lng: 3.5354 },
  'lagos.national-museum-lagos': { lat: 6.4430, lng: 3.4030 },
  'hong-kong.victoria-peak': { lat: 22.2759, lng: 114.1455 },
  'hong-kong.star-ferry': { lat: 22.2930, lng: 114.1696 },
  'hong-kong.tian-tan-buddha': { lat: 22.2539, lng: 113.9050 },
  'amsterdam.rijksmuseum': { lat: 52.3600, lng: 4.8852 },
  'amsterdam.anne-frank-house': { lat: 52.3752, lng: 4.8840 },
  'amsterdam.canal-ring': { lat: 52.3702, lng: 4.8904 },
  'honolulu.waikiki-beach': { lat: 21.2767, lng: -157.8262 },
  'honolulu.pearl-harbor': { lat: 21.3650, lng: -157.9500 },
  'honolulu.iolani-palace': { lat: 21.3069, lng: -157.8583 },
  'miami.south-beach': { lat: 25.7826, lng: -80.1341 },
  'miami.vizcaya': { lat: 25.7440, lng: -80.2102 },
  'miami.wynwood-walls': { lat: 25.8011, lng: -80.1994 },
  'bogota.gold-museum': { lat: 4.6019, lng: -74.0720 },
  'bogota.monserrate': { lat: 4.6058, lng: -74.0564 },
  'bogota.plaza-bolivar': { lat: 4.5981, lng: -74.0758 },
  'reykjavik.hallgrimskirkja': { lat: 64.1417, lng: -21.9266 },
  'reykjavik.harpa': { lat: 64.1503, lng: -21.9327 },
  'reykjavik.perlan': { lat: 64.1292, lng: -21.9186 },
  'nairobi.nairobi-national-park': { lat: -1.3733, lng: 36.8589 },
  'nairobi.sheldrick-wildlife-trust': { lat: -1.3760, lng: 36.7719 },
  'nairobi.karen-blixen-museum': { lat: -1.3516, lng: 36.7108 },
  'lima.plaza-mayor': { lat: -12.0464, lng: -77.0300 },
  'lima.larco-museum': { lat: -12.0724, lng: -77.0708 },
  'lima.huaca-pucllana': { lat: -12.1117, lng: -77.0333 },
  'perth.kings-park': { lat: -31.9610, lng: 115.8320 },
  'perth.fremantle-prison': { lat: -32.0559, lng: 115.7537 },
  'perth.cottesloe-beach': { lat: -31.9940, lng: 115.7510 },
  'auckland.sky-tower': { lat: -36.8485, lng: 174.7622 },
  'auckland.auckland-museum': { lat: -36.8608, lng: 174.7778 },
  'auckland.mount-eden': { lat: -36.8783, lng: 174.7647 },
  'suva.fiji-museum': { lat: -18.1485, lng: 178.4230 },
  'suva.suva-municipal-market': { lat: -18.1404, lng: 178.4246 },
  'suva.colo-i-suva': { lat: -18.0705, lng: 178.4525 },
  'ulaanbaatar.gandan-monastery': { lat: 47.9205, lng: 106.8940 },
  'ulaanbaatar.sukhbaatar-square': { lat: 47.9186, lng: 106.9176 },
  'ulaanbaatar.zaisan-memorial': { lat: 47.8845, lng: 106.9157 },
  'almaty.kok-tobe': { lat: 43.2336, lng: 76.9760 },
  'almaty.ascension-cathedral': { lat: 43.2583, lng: 76.9534 },
  'almaty.medeu': { lat: 43.1571, lng: 77.0581 },
  'madrid.prado-museum': { lat: 40.4138, lng: -3.6921 },
  'madrid.royal-palace': { lat: 40.4179, lng: -3.7143 },
  'madrid.plaza-mayor': { lat: 40.4155, lng: -3.7074 },
  'lisbon.belem-tower': { lat: 38.6916, lng: -9.2160 },
  'lisbon.jeronimos-monastery': { lat: 38.6978, lng: -9.2061 },
  'lisbon.sao-jorge-castle': { lat: 38.7139, lng: -9.1335 },
  'dublin.trinity-college-library': { lat: 53.3438, lng: -6.2546 },
  'dublin.dublin-castle': { lat: 53.3429, lng: -6.2674 },
  'dublin.guinness-storehouse': { lat: 53.3419, lng: -6.2867 },
  'dakar.goree-island': { lat: 14.6672, lng: -17.3983 },
  'dakar.african-renaissance-monument': { lat: 14.7222, lng: -17.4950 },
  'dakar.ifan-museum': { lat: 14.6677, lng: -17.4389 },
  'recife.recife-antigo': { lat: -8.0631, lng: -34.8711 },
  'recife.ricardo-brennand': { lat: -8.0661, lng: -34.9597 },
  'recife.boa-viagem': { lat: -8.1250, lng: -34.9000 },
  'panama-city.panama-canal': { lat: 8.9943, lng: -79.5900 },
  'panama-city.casco-viejo': { lat: 8.9513, lng: -79.5352 },
  'panama-city.biomuseo': { lat: 8.9348, lng: -79.5447 },
  'santiago.cerro-san-cristobal': { lat: -33.4254, lng: -70.6337 },
  'santiago.plaza-de-armas': { lat: -33.4378, lng: -70.6505 },
  'santiago.la-moneda': { lat: -33.4430, lng: -70.6539 },
  'addis-ababa.national-museum': { lat: 9.0385, lng: 38.7616 },
  'addis-ababa.holy-trinity-cathedral': { lat: 9.0301, lng: 38.7669 },
  'addis-ababa.entoto': { lat: 9.0864, lng: 38.7648 },
  'delhi.red-fort': { lat: 28.6562, lng: 77.2410 },
  'delhi.qutub-minar': { lat: 28.5245, lng: 77.1855 },
  'delhi.india-gate': { lat: 28.6129, lng: 77.2295 },
  'manila.intramuros': { lat: 14.5896, lng: 120.9747 },
  'manila.rizal-park': { lat: 14.5826, lng: 120.9786 },
  'manila.san-agustin-church': { lat: 14.5898, lng: 120.9741 },
  'ho-chi-minh-city.war-remnants-museum': { lat: 10.7794, lng: 106.6920 },
  'ho-chi-minh-city.ben-thanh-market': { lat: 10.7725, lng: 106.6980 },
  'ho-chi-minh-city.independence-palace': { lat: 10.7771, lng: 106.6953 },
};

function withTravelAttractionCoordinates(destinationId: string, travelAnchors: TravelAnchors): TravelAnchors {
  return {
    ...travelAnchors,
    attractions: travelAnchors.attractions.map((attraction) => ({
      ...attraction,
      ...TRAVEL_ATTRACTION_COORDS[`${destinationId}.${attraction.id}`],
    })),
  };
}
